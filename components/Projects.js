...
const Project = () => {
        ...
        <section className={`container-fluid p-0 vh-100`}>
            <div className={`project__view overflow-hidden position-relative d-flex flex-column-reverse`}>
                <ul className='project__view__list'>
                    <div className='project__view__list__title'>Latest projects</div>
