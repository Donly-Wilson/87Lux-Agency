    ...
    return (
      // <div>
          <section className= {`container position-relative vh-100 p-0`}>
            <div className= {`team__title position-absolute top-0 left-0 justify-content-center align-items-center d-flex w-100 h-100`}>
                <h1>Meet the team</h1>
            </div>
            <div className= {`team__member position-absolute top-0 left-0 w-100`}>
                <div className= {'team__member--blue'}>
                    <img src="./img/team2.jpg" alt="team member "/>
                </div>
                <div className= {'team__member--yellow'}><img src="./img/team3.jpg" alt="team member"/></div>
                <div className= {'team__member--red'}>
